...
if session == 1
    switch bl_ind
        case 0
            input_counterbalance_file = v1;
        case 1
            input_counterbalance_file = v1;
        case 2
            input_counterbalance_file = v1;
        case 3
            input_counterbalance_file = v2;
        case 4
            input_counterbalance_file = v2;
        case 5
            input_counterbalance_file = v2;
...
tmpFileTxt = fullfile(sub_save_dir,[strcat('sub-', sprintf('%04d', sub)), '_task-',taskname,'_temp-beh.txt' ]);
writetable(T,tmpFileTxt);
