...
diaryname = sprintf('/Users/h/Dropbox/Projects/social_influence/design/jitter/social_inf_Events_best_design_of_10000_%s.txt', strrep(ver) );
diary(diaryname)
print_matrix(best_design_struct.eventlist, best_design_struct.eventlist_names);
diary off

diaryname = sprintf('/Users/h/Dropbox/Projects/social_influence/design/jitter/social_inf_Events_best_design_of_10000_under_ideal_length_sec_%s.txt', strrep(ver) );
diary(diaryname)
