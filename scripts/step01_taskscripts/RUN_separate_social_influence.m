...
%             cognitive(sub,c1,4,session);vicarious(sub,v2,5,session);pain(sub,p2,6,session);
        ...
        case 1 % v1 c1 p1 p2 c2 v2
            task1 = 'pain'; task2 = 'cognitive'; task3 = 'vicarious';
...
run_task1 = strcat(task1,'(',num2str(sub_num),",'",char(task1_cb), "',",num2str(task1_order),',',num2str(session), ')');
run_task2 = strcat(task2,'(',num2str(sub_num),",'",char(task2_cb), "',",num2str(task2_order),',',num2str(session), ')');
run_task3 = strcat(task3,'(',num2str(sub_num),",'",char(task3_cb), "',",num2str(task3_order),',',num2str(session), ')');
