function [meanrecipvif, vifs, design_struct] = s121902_generate_jittered_er_design(varargin)
...
ISI2mean = 5;     %2       % For 'exponential' only.  Includes ISImin.  There is an optimal empirical value -- longer is better for deconvolution/FIR, but we also need to fit within total scan time constraints.
