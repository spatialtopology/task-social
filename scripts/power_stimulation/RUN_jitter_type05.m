...
%         [meanrecipvif(i, 1), vifs, design_struct] = generate_jittered_er_design_HJ('noplot', 'ISImean', ISImean);
        [meanrecipvif(i, 1), vifs, design_struct] = generate_jitter_type02('noplot', 'ISI1mean', ISI1mean, 'ISI2mean', ISI2mean, 'ISI3mean', ISI3mean, 'ISI4mean', ISI4mean);
...
% Save best results
% --------------------------------------------------------------------------
output_dir = '/Users/h/Documents/projects_local/social_influence/design_interleaved/jitter_type05';
