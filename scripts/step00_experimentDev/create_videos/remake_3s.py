...
# if less than 96, pad it with black Frames
# create video
import os
import cv2
...
def generate_video(image_folder, video_name, save_dir, fps, fourcc, subnum_folder, af_fldr):
    ...
    images.sort()
# identify max PSPI
# /Users/h/Dropbox/projects_dropbox/socialPain/sandbox/resources/vicariousBackPainVideos/Images\ 2/123-jh123/jh123t1aaunaff/jh123t1aaunaff068.png
    ...
    if max_ind  > 48:
        ...
        new_images = images[60:156]#images[0:96]
        new_images.sort()
