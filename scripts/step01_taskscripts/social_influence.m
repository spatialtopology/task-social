...
index = rem(sub,10)
c1 = 'task-cognitive_counterbalance_ver-0' str(r_seq(index+1)) 'block-01'
c2 = 'task-cognitive_counterbalance_ver-0' str(r_seq(index+1)) 'block-02'
p1 = 'task-pain_counterbalance_ver-0' str(r_seq(index+1)) 'block-01'
p2 = 'task-pain_counterbalance_ver-0' str(r_seq(index+1)) 'block-02'
v1 = 'task-vicarious_counterbalance_ver-0' str(r_seq(index+1)) 'block-01'
v2 = 'task-vicarious_counterbalance_ver-0' str(r_seq(index+1)) 'block-02'
